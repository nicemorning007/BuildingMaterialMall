                                    ...
                                    <table class="datatable table table-striped" cellspacing="0" width="100%"
                                        ...
                                        <tr>
                                            <s:form action="userControlAction_userForbidden" method="POST">
                                                ...
                                                <td>
                                                    <s:submit value="注销" cssClass="btn btn-warning"
                                                              cssStyle="width: 40%"/>
                                                </td>
                                            </s:form>
                                        </tr>
                                        ...
                                        %>
                                        <tr>
                                            <s:form action="userControlAction_unUserForbidden" method="POST">
                                                ...
                                                <td>
                                                    <s:submit value="已注销" cssClass="btn btn-warning"
                                                              cssStyle="width: 40%"/>
                                                </td>
                                            </s:form>
                                        </tr>
