                                    ...
                                    <table class="datatable table table-striped" cellspacing="0" width="100%"
                                        ...
                                        <%
                                            ...
                                            for (UserinfoEntity userinfoEntity : list) {
                                                if (userControlDAO.getUserState(userinfoEntity.getId()) != 2 && userControlDAO.getUserState(userinfoEntity.getId()) != 3) {
                                        %>
                                        <tr>
                                            <s:form action="userControlAction_lossReporting" method="POST">
                                                ...
                                                <td>
                                                    <s:submit value="挂失" cssClass="btn btn-warning"
                                                              cssStyle="width: 40%"/>
                                                </td>
                                            </s:form>
                                        </tr>
                                        ...
                                        %>
                                        <tr>
                                            <s:form action="userControlAction_unLossReporting" method="POST">
                                                ...
                                                <td>
                                                    <s:submit value="已挂失" cssClass="btn btn-warning"
                                                              cssStyle="width: 40%"/>
                                                </td>
                                            </s:form>
                                        </tr>
