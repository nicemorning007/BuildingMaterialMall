            ...
            <div class="col-md-8 products-single">
                <div class="col-md-5 grid-single">
                    <div class="flexslider">
                        <ul class="slides">
                            ...
                            %>
                            <li data-thumb="${pageContext.request.contextPath}/images/nopre.jpg">
                ...
                <div class="col-md-7 single-text">
                    <div class="details-left-info simpleCart_shelfItem">
                        <h3><%=goodsControlDAO.getNameById(goodsId)%>
                        </h3>
                        <div class="price_single">
                            <span class="actual item_price">￥<%=goodsControlDAO.getPriceById(goodsId)%></span>
                        </div>
                        <h3>单位：<%=goodsControlDAO.getUnitById(goodsId)%>
                        </h3>
                        <ul class="size">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <%=goodsControlDAO.getInfoById(goodsId)%>
                            <%
                                for (int i = 0; i < 6; i++) {
                                    if (goodsControlDAO.getPicPathByGoodsId(goodsId, i) != null) {
                            %>
