        ...
        <div class="account-bottom">
            <div class="col-md-6 account-left second">
                ...
                <s:form action="loginAction" theme="simple" method="POST">
                    ...
                    <div class="address">
                        <a class="forgot" href="${pageContext.request.contextPath}/forgetPassword.jsp">忘记密码?</a>
                        <s:submit type="submit" value="登陆"/>
                        <a class="forgot" href="${pageContext.request.contextPath}/register.jsp" style="float: right">没有账号?点此注册</a>
                    </div>
                </s:form>
            </div>
        </div>
